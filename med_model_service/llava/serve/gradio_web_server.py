...
def load_demo(url_params, request: gr.Request):
    ...
    if "llava_med" in url_params:
        model = url_params["llava_med"]
        if model in models:
...
learn_more_markdown = ("""
### License
The service is a research preview intended for non-commercial use only, subject to the llava_med [License](https://github.com/facebookresearch/llama/blob/main/MODEL_CARD.md) of LLaMA, [Terms of Use](https://openai.com/policies/terms-of-use) of the data generated by OpenAI, and [Privacy Practices](https://chrome.google.com/webstore/detail/sharegpt-share-your-chatg/daiacboceoaocpibfodeljbdfacokfjb) of ShareGPT. Please contact us if you find any potential violation.
""")
...
def build_demo(embed_mode):
    ...
    with gr.Blocks(title="LLaVA", theme=gr.themes.Default(), css=block_css) as demo:
        ...
        if args.model_list_mode == "once":
            ...
            raise ValueError(f"Unknown llava_med list mode: {args.model_list_mode}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--llava_med-list-mode", type=str, default="once",
        choices=["once", "reload"])
